...
public class SongHudOverlay implements HudRenderCallback {
    public static Identifier SPOTIFY_LOGO = new Identifier(SpotifyIntegrationMod.MOD_ID, "textures/logo.png");
    ...
    public static Identifier PROGRESS_BAR_EMPTY = SHADOW;
    public static Identifier PROGRESS_BAR = new Identifier(SpotifyIntegrationMod.MOD_ID, "textures/progress.png");
