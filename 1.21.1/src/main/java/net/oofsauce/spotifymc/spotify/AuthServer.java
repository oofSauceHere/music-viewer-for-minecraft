...
import net.oofsauce.spotifymc.spotify.server.LoginHandler;
import net.oofsauce.spotifymc.spotify.server.CallbackHandler;
import net.oofsauce.spotifymc.spotify.server.RefreshTokenHandler;
...
public class AuthServer {
    ...
    public static void runServer() throws IOException {
        ...
        InputStream in = AuthServer.class.getResourceAsStream("/app.properties");
        props.load(in);
