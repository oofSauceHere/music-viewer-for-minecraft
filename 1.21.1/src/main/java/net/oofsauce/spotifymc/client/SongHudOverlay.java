package net.oofsauce.spotifymc.client;
...
import net.oofsauce.spotifymc.SpotifyMC;
import net.oofsauce.spotifymc.spotify.SpotifyAPI;

import java.awt.font.FontRenderContext;

public class SongHudOverlay implements HudRenderCallback {
    public static final Identifier SPOTIFY_LOGO = Identifier.tryParse(SpotifyMC.MOD_ID, "textures/logo.png");
    ...
    public static final Identifier SHADOW = Identifier.tryParse(SpotifyMC.MOD_ID, "textures/shadow.png");
    public static final Identifier PROGRESS_BAR_EMPTY = SHADOW;
    public static final Identifier PROGRESS_BAR = Identifier.tryParse(SpotifyMC.MOD_ID, "textures/progress.png");
